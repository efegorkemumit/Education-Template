  ...
  return (
    ...
    <div className='  p-3 text-center'>
          <p className='text-4xl font-roboto font-semibold uppercase mt-6 mb-20 '>
            <span className='border-b font-extralight   text-black dark:text-white'>
            Our services
            </span>
            </p>
    ...
    <div className='grid grid-cols-1 lg:grid-cols-4 gap-8'>
        ...
        <div className='text-center p-4 rounded-xl'>
            <svg className="w-24 h-24 mx-auto p-3 mb-4 text-second-light bg-gray-800 rounded-full" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" >
